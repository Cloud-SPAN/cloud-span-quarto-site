...
Learners who were already confident with their command line abilities were encouraged to complete Genomics and Metagenomics. An [online assessment](https://shiny.york.ac.uk/er13/prenomics-quiz/#section-why) was developed for learners to self assess their level of knowledge and help them to gauge which course would be most appropriate for them. These modules enhancing specialised skills provide researchers with the advanced knowledge and skills required to generate and analyse 'omics data using Cloud HPC resources.
