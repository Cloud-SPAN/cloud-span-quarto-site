...
(1) how to configure and run the scripts to create and manage instances for workshops, manage late registrations and cancellations, and troubleshooting
(2) how to create, manage and configure AMI templates (from which instances are created) with your own data and software analysis tools
(3) how the scripts work so you can customise them.
