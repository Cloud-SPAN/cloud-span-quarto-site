...
![.](../../images/project_themes_final.png){fig-alt="A graphic showing the themes." width="600"} 

![Project Themes](project_themes_final.png){width=600}
...
[Health and bioscience IDEAS](https://healthbioscienceideas.github.io/)
Imaging, data structures, genetics and analytical strategies 

[Innovation Scholars Programme - Big Data Skills Training](https://innovationscholars.er.kcl.ac.uk/training/)

[Learn to Discover](https://learntodiscover.ai/)
A training platform in data sciences and machine learning for biomedicine and health researchers

[Radiance](https://radiance.org.uk/)
Rigorous training in longitudinal data science 

[T3connect](https://t3connect.org/)
Train the trainer in data science for pathogen genomics and surveillance. Expanding pathogen genomics expertise across the UK 
