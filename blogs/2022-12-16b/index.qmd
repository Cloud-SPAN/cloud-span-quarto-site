...
![.](code-retreat-graphic-joao.png){fig-alt="A graphic showing a photo and the comment of one our partic ipants to a previous code retreat" width="700"}
...
Sign up using the [registration form](https://forms.gle/51AmCtGhmm41xCc26)
